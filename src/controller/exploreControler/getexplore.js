...
exports.getTopTweetAndHastag = async (req, res) => {
    ...
    try {
        ...
        let TopTweet = `
        SELECT users.username,users.id as user_id,users.name,users.profile_img_url as profile_img_url, 
        tweets.content,tweets.id as tweet_id,tweet_comments.content as comments, 
        CASE
            ...
            CASE
              ...
              END
          END as time, medias.media_url as media_urlFROM users
...
exports.getMedia = async (req, res) => {
    ...
    try {
        ...
        let [result] = await connection.query(sql);
        console.log("the reeult is the ", result);
