const retweet = async (tweetId, icon, status) => {
  ...
  <ul class=" text-sm text-gray-700  aria-labelledby="dropdownDefaultButton">
      <li>
      <div id='directRetweet' class="z-30 bg-white cursor-pointer rounded-lg text-center flex p-3 shadow-2xl" style="height:52px; width:147px;margin-left: -125px;
      margin-top: -10px;" >
      <a class="my-auto" >
      ...
      <li>
      <div id='quote' class="z-30 bg-white cursor-pointer rounded-lg text-center flex hover:bg-gray-400 p-3 shadow-2xl" style="height:52px; width:147px;margin-left: -125px;
      margin-top: -10px;
   >
      <a class="my-auto" >
      ...
      <span class="px-2  py-auto">
          <p id="${temp + 2}" class="font-bold text-black size-10">Quote</p>
      </span>
  </div>
      </li>
  </ul>
  ...
  <ul class=" text-sm text-gray-700  aria-labelledby="dropdownDefaultButton">
      <li>
      <div id='directRetweet' class="z-30 bg-white cursor-pointer rounded-lg text-center flex  hover:bg-slate-300  p-3 shadow-2xl" style="height:52px; width:147px; margin-left: -125px;
      margin-top: -10px;" >
      <a class="my-auto" >
          <svg class="text-center h-7 w-6" fill="black" stroke-linecap="round"
          stroke-linejoin="round" stroke-width="2" stroke="currentColor"
